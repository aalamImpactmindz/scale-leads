...
const PageDOnboarding = () => {
  return (
    <div className="onboarding mb-4">
      ...
      <Form className="d-bg-gradient p-4 rounded-2" onSubmit={handleSubmit}>
        <Row className="row-cols-1 row-cols-md-2 g-0 g-md-4">
          <Col>
            <Form.Group
              className="mb-3"
              controlId="formDOnboardingIdealCustomer"
            >
          ...
          <Col>
            <Form.Group className="mb-3" controlId="formDOnboardingSector">
        ...
        <Row className="row-cols-1 row-cols-md-2 g-0 g-md-4">
          <Col>
            <Form.Group className="mb-3" controlId="formDOnboardingCompanySize">
          ...
          <Col>
            <Form.Group className="mb-3" controlId="formDOnboardingObjective">
        ...
        <Row className="row-cols-1 row-cols-md-2 g-0 g-md-4">
          <Col>
            <Form.Group className="mb-3" controlId="formDOnboardingYourOffer">
          ...
          <Col>
            <Form.Group className="mb-3" controlId="formDOnboardingYourWebsite">
        ...
        <Row className="row-cols-1 row-cols-md-2 g-0 g-md-4">
          <Col>
            <Form.Group className="mb-3" controlId="formDOnboardingChannel">
          ...
          <Col>
            <Form.Group
              className="mb-3"
              controlId="formDOnboardingMessageCount"
            >
        ...
        <Row className="row-cols-1 row-cols-md-2 g-0 g-md-4">
          <Col>
            <Form.Group
              className="mb-3"
              controlId="formDOnboardingFollowUpDelay"
            >
              <Form.Label>
          ...
          <Col>
            <Form.Group className="mb-3" controlId="formDOnboardingTone">
              <Form.Label>
        ...
        <Row className="row-cols-1 row-cols-md-2 g-0 g-md-4">
          <Col>
            <Form.Group className="mb-3" controlId="formDOnboardingMessages">
          ...
          <Col>
            <Form.Group className="mb-3" controlId="formDOnboardingCompetitors">
              <Form.Label>
